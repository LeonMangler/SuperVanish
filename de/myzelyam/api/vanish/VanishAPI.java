...
public class VanishAPI {
    ...
    static {
        Plugin bukkitPlugin = Bukkit.getPluginManager().getPlugin("SuperVanish");
        if (bukkitPlugin == null || !(bukkitPlugin instanceof SuperVanish)) {
        ...
        plugin = (SuperVanish) bukkitPlugin;
    }
