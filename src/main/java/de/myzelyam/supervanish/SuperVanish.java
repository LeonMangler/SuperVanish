...
public class SuperVanish extends JavaPlugin implements SuperVanishPlugin {
    ...
    public static final String[] NON_REQUIRED_SETTINGS_UPDATES = {"6.0.0", "6.0.1", "6.0.2", "6.0.3",
            ...
            "6.1.8", "6.2.0", "6.2.1", "6.2.2", "6.2.3", "6.2.4", "6.2.5", "6.2.6", "6.2.7"},
    ...
    public void onEnable() {
        try {
            ...
            if (!Bukkit.getOnlinePlayers().isEmpty())
                onReload();
            if (getVersionUtil().isOneDotXOrHigher(19)) {
                getLogger().warning("1.19 support is still experimental! Due to this the following features are currently not working: NightVisionEffect");
            }
        } catch (Exception e) {
            logException(e);
        }
